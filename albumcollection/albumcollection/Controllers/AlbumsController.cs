...
namespace albumcollection.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Artist,Title,Label,Genre,ReleaseYear")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Artist,Title,Label,Genre,ReleaseYear")] Album album)
        {
            if (id != album.Id)
            {
                return NotFound();
